 ...
 * File: GetHousingInfData - API Call
 * Description: This file is deployed as a function app that grabs the
 * most recent instance of a Housing Inflationary Rate reading from FRED.
...
module.exports = async function (context, req) {
  try {
    ...
    await storeDataInAzureDB(context, housingInflationData);
